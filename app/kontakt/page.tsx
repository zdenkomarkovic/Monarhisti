...
export default function KontaktPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (validateForm()) {
      // TODO: Implement form submission (Server Action or API route)
      alert('Forma je validna! Implementirajte slanje emaila.');
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg
                    className="w-6 h-6 text-royal-gold mr-3 mt-1"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-royal-blue hover:text-royal-gold transition-colors"
                    >
                      {CONTACT_INFO.email}
                    </a>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="font-semibold text-gray-700">Адреса</p>
